...
class MongoCRUD:
    ...
    def group_data_by_category(self, items):
        ...
        # Adds remaining categories not in desired_order
        remaining_categories = [cat for cat in grouped if cat not in desired_order]

        final_order = desired_order + sorted(remaining_categories) # Final order
